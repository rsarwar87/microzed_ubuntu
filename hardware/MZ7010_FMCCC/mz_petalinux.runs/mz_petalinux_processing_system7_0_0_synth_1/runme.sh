...
HD_PWD='/home/training/git/avnet/hdl/Projects/mz_petalinux/MZ7010_FMCCC/mz_petalinux.runs/mz_petalinux_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mz_petalinux_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mz_petalinux_processing_system7_0_0.tcl
