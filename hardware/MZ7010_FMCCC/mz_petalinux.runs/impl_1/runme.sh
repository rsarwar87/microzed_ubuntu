...
HD_PWD='/home/training/git/avnet/hdl/Projects/mz_petalinux/MZ7010_FMCCC/mz_petalinux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mz_petalinux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mz_petalinux_wrapper.tcl -notrace
